...
const Configurator = () => {
  ...
  const [matchUpFormatParsed, setMatchUpFormatParsed] = useState(matchUpFormatCode.parse('SET3-S:6'));
  ...
  return (
    <>
      ...
      <Paper className={classes.paper} elevation={2}>
        ...
        The goal of the Tennis Open Data Standards (TODS) project is to create a single data exchange framework that
        allows the transfer of any tennis-related data between different information systems using consistent, agreed
        formats and methods.
        <p>
